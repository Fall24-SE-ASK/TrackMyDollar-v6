...
|-----|------|------|
|94   | Total	| |
|3 |Video-demo mp4 in GH showing functionalities|https://www.youtube.com/watch?v=LZnSmxAyVUo|
|3	| Short release cycles| https://github.com/Fall24-SE-ASK/TrackMyDollar-v6/releases |
|3	| Workload is spread over the whole team | Each member worked on features, docs, fixes & test -> https://github.com/Fall24-SE-ASK/TrackMyDollar-v6/pulse |
|3	| Docs: why: docs tell a story, motivate the whole thing, deliver a punchline that makes you want to rush out and use the thing	| Updated documentation for each feature -> https://github.com/Fall24-SE-ASK/TrackMyDollar-v6/tree/main/docs|
|3	| File CONTRIBUTING.md lists coding standards and lots of tips on how to extend the system without screwing things up| https://github.com/Fall24-SE-ASK/TrackMyDollar-v6/blob/main/CONTRIBUTING.md |	
|3	| Docs: doco generated , format not ugly|	https://github.com/Fall24-SE-ASK/TrackMyDollar-v6/tree/main/docs|
|3	| Evidence that the whole team is using the same tools (e.g. config files in the repo, updated by lots of different people)	| |
|3	| Evidence that the members of the team are working across multiple places in the code base|	https://github.com/Fall24-SE-ASK/TrackMyDollar-v6/pulse|
|3	| Docs: what: point descriptions of each class/function (in isolation)|	 https://github.com/Fall24-SE-ASK/TrackMyDollar-v6/tree/main/docs|
|3  | Number of commits: by different people| https://github.com/Fall24-SE-ASK/TrackMyDollar-v6/graphs/commit-activity	https://github.com/Fall24-SE-ASK/TrackMyDollar-v6/pulse|
|3	| Issues are being closed| 5 Issues closed -> https://github.com/Fall24-SE-ASK/TrackMyDollar-v6/issues |
|3	| Issues are discussed before they are closed|	Each issue is updated with the discussion before closing and comments added -> https://github.com/Fall24-SE-ASK/TrackMyDollar-v6/issues|
|3	| Use of syntax checkers.| Use of Pylint, updated in test.yml -> https://github.com/Fall24-SE-ASK/TrackMyDollar-v6/blob/main/.github/workflows/test.yml|
|3	| Issues reports: | https://github.com/Fall24-SE-ASK/TrackMyDollar-v6/issues |
|3	| Use of code formatters.| config files in GH showing your this formatter's config| Use of Black, updated in test.yml -> https://github.com/Fall24-SE-ASK/TrackMyDollar-v6/blob/main/.github/workflows/test.yml|
|3	| Use of style checkers	config files in GH showing your config| Use of Black, updated in test.yml -> https://github.com/Fall24-SE-ASK/TrackMyDollar-v6/blob/main/.github/workflows/test.yml|
|3	| Docs: short video, animated, hosted on your repo. That convinces people why they want to work on your code.|	Added in Readme.md -> https://github.com/Fall24-SE-ASK/TrackMyDollar-v6/blob/main/README.md|
|3  | Test cases exist | 111 test cases with coverage > 82% for each file -> https://github.com/Fall24-SE-ASK/TrackMyDollar-v6/blob/main/.github/workflows/test.yml|
|3	| Use of code coverage	| https://github.com/Fall24-SE-ASK/TrackMyDollar-v6/blob/main/.github/workflows/test.yml |
|3	| Other automated analysis tools | https://github.com/Fall24-SE-ASK/TrackMyDollar-v6/blob/main/.github/workflows/test.yml |
|3 | Test cases:.a large proportion of the issues related to handling failing cases. (if a test case fails, open an issue and fix it Yes, for example| https://github.com/Fall24-SE-ASK/TrackMyDollar-v6/issues | 
|3	| Test cases are routinely executed	| Cron Jobs in yml files |
|3	| Documentation describing how this version improves on the older version| Updated README.md to show the Delta -> https://github.com/Fall24-SE-ASK/TrackMyDollar-v6/blob/main/README.md	|
|3	| This version is a little(1), some(2), much(3) improved on the last version. | Tutor's assessment |
|Y| 1.1 Does your website and documentation provide a clear, high-level overview of your software? | https://github.com/Fall24-SE-ASK/TrackMyDollar-v6/blob/main/README.md |
|Y| 1.2: Does your website and documentation clearly describe the type of user who should use your software?   | https://github.com/Fall24-SE-ASK/TrackMyDollar-v6/blob/main/README.md |
|N| 1.3: Do you publish case studies to show how your software has been used by yourself and others? | https://github.com/Fall24-SE-ASK/TrackMyDollar-v6/blob/main/docs/history.md |
...
|Y| 3.2: Is your software available for free?  |https://github.com/Fall24-SE-ASK/TrackMyDollar-v6|
|Y| 3.3: Is your source code publicly available to download, either as a downloadable bundle or via access to a source code repository? |https://github.com/Fall24-SE-ASK/TrackMyDollar-v6|
...
|Y| 4.1: Is your documentation clearly available on your website or within your software? |https://github.com/Fall24-SE-ASK/TrackMyDollar-v6/blob/main/README.md|
|Y| 4.2: Does your documentation include a "quick start" guide, that provides a short overview of how to use your software with some basic examples of use?  |https://github.com/Fall24-SE-ASK/TrackMyDollar-v6/blob/main/README.md|
|Y| 4.3: If you provide more extensive documentation, does this provide clear, step-by-step instructions on how to deploy and use your software? |https://github.com/Fall24-SE-ASK/TrackMyDollar-v6/blob/main/README.md|
